...
var ChatItem = function (_a) {
    ...
    var onExpandItem = function (e, id) {
        e.preventDefault();
        e.stopPropagation();
    ...
    return (_jsx(_Fragment, { children: _jsx("div", __assign({ className: classNames('rce-container-citem', props.className), onClick: handleOnClick, onContextMenu: props.onContextMenu }, { children: _jsxs("div", __assign({ className: 'rce-citem', onDragOver: onDragOver, onDragEnter: onDragEnter, onDragLeave: onDragLeave, onDrop: onDrop }, { children: [!!props.onDragComponent && onDrag && props.onDragComponent(props.id), ((onDrag && !props.onDragComponent) || !onDrag) && [
                        _jsxs("div", __assign({ className: classNames('rce-citem-avatar', { 'rce-citem-status-encircle': statusColorType === 'encircle' }) }, { children: [_jsx(Avatar, { src: props.avatar, alt: props.alt, className: statusColorType === 'encircle' ? 'rce-citem-avatar-encircle-status' : '', size: props.avatarSize || 'large', letterItem: props.letterItem, sideElement: props.statusColor ? (_jsx("span", __assign({ className: 'rce-citem-status', style: statusColorType === 'encircle'
                                            ? {
                                                border: "solid 2px ".concat(props.statusColor),
                                            }
                                            : {
                                                backgroundColor: props.statusColor,
                                            } }, { children: props.statusText }))) : (_jsx(_Fragment, {})), onError: onAvatarError, lazyLoadingImage: lazyLoadingImage, type: classNames('circle', { 'flexible': avatarFlexible }) }), props.subList && props.subList.length > 0 && (_jsx("button", __assign({ className: 'rce-citem-expand-button', onClick: function (e) { return onExpandItem(e, props.id); } }, { children: props.expanded ? _jsx(FaArrowUp, {}) : _jsx(FaArrowDown, {}) })))] }), 'avatar'),
